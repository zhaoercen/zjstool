...
;(function(window, undefined) {
   ...
   *
   * Note: In the development src, `_.template` utilizes sourceURLs for easier
   * debugging. See http://www.html5rocks.com/en/tutorials/developertools/sourcemaps/#toc-sourceurl
   *
   * Note: Lo-Dash may be used in Chrome extensions by either creating a `lodash csp`
   * src and using precompiled templates, or loading Lo-Dash in a sandbox.
   *
  ...
  function template(text, data, options) {
    ...
    // inlining compiled templates during the src process
  ...
  // expose Lo-Dash
  // some AMD src optimizers, like r.js, check for specific condition patterns like the following:
  ...
  // check for `exports` after `define` in case a src optimizer adds an `exports` object
  else if (freeExports) {
